...
<body>
    ...
    <!-- Sidebar Navigation (កែប្រែ Route Links ឱ្យរត់ទៅ Controller) -->
    <div class="sidebar">
        <h2>Admin Panel</h2>
        ...
        <a href="${pageContext.request.contextPath}/orders" class="active">View Orders</a>
    </div>
                ...
                <tbody>
                    <c:forEach var="order" items="${ordersList}">
                        <tr>
                            ...
                            <td>
                                <span class="status-badge status-${not empty order.status ? order.status.toLowerCase() : 'pending'}">
                                    ${not empty order.status ? order.status : 'PENDING'}
                                </span>
                            </td>
                        </tr>
                    </c:forEach>
